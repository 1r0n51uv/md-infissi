                ...
                <section className="about_us_area about_us_2 row">
                    ...
                    <div className="container" style={{marginTop: '5%'}}>
                        ...
                        <div className="tittle wow fadeInUp">
                            <h1 style={{fontFamily: 'Oswald'}}>BATTENTE PVC</h1>
                        </div>
                        ...
                        <div className="row about_row about_us2_pages center-block">
                            ...
                            <div className="col-md-2 center-block">
                                ...
                                <img
                                    src="https://firebasestorage.googleapis.com/v0/b/mdinfissi-dd57c.appspot.com/o/products%2Fserramenti%2FbattentePVC%2Frender_md68.jpg?alt=media&token=c9c08dcb-13ba-45db-9f7e-043da67a10a0"
                            ...
                            <div className="col-md-4">
                                <img
                                    src="https://firebasestorage.googleapis.com/v0/b/mdinfissi-dd57c.appspot.com/o/products%2Fserramenti%2FbattentePVC%2Fnodo_md68.jpg?alt=media&token=431db8b3-d818-4d16-9c89-5d3626568b37"
                                    className="img-responsive"
                                    alt=""/>
                            </div>
                            ...
                            <div className="col-md-6 wow fadeInLeft">
                                ...
                                <h4><b>SCHEDA TECNICA SERIE:</b> 7001-MD68</h4>

                                <hr/>

                                <h4><b>PROFILATI:</b> PVC A 7 CAMERE</h4>
                                <h4 style={{marginTop: '1%'}}><b>TIPO DI TENUTA ARIA ACQUA:</b> Giunto aperto e sormonto con doppia battuta</h4>
                                <h4 style={{marginTop: '1%'}}><b>APPLICAZIONI VETRO:</b> con fermavetro arrotondato e squadrato</h4>
                                <h4 style={{marginTop: '1%'}}><b>CAMERA VETRO:</b> variabile a seconda del fermavetro utilizzato (min 25mm – max42mm)</h4>
                                <h4 style={{marginTop: '1%'}}><b>PROFILI SIA ARROTONDATI CHE SQUADRATI</b></h4>
                                ...
                                <h4><b>Telaio fisso:</b> sezione da mm. 68</h4>
                                <h4 style={{marginTop: '1%'}}><b>Telaio mobile:</b> sezione mm. 76</h4>
                                <h4 style={{marginTop: '1%'}}><b>Fuga telaio/anta:</b> 6mm</h4>
                                <h4 style={{marginTop: '1%'}}><b>Aletta di battuta vetro:</b> mm. 21</h4>
                                <h4 style={{marginTop: '1%'}}><b>Aletta di battuta a muro:</b> 25/35/65 mm</h4>
                                ...
                                <img
                                    style={{width: '100%'}}
                                    src="https://firebasestorage.googleapis.com/v0/b/mdinfissi-dd57c.appspot.com/o/products%2Fserramenti%2FbattentePVC%2Ftipmar70tt-1.png?alt=media&token=1e7d47e4-fc59-47f0-8db3-96dd2cbf12f2" alt=""/>
